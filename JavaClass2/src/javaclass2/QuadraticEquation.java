...
public class QuadraticEquation {
	...
	public static void main(String[] args) {
		...
		DecimalFormat df = new DecimalFormat("0.00"); // a decimal formatter so we don't get super large numbers;
		...
		try { // exception handling
			...
			do { // while is used so the program will restart after calculating the equation is
